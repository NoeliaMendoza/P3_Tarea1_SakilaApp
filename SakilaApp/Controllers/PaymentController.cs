...
public class PaymentController : Controller
{
    ...
    // CreatePayPalOrder replica la estructura de CreateLink (PayPhone) con dos diferencias clave:
    // 1. PayPal Sandbox exige un monto minimo de $1.00, validacion que PayPhone no tiene.
    // 2. En lugar de redirigir a una vista propia, usa Redirect(result.ApprovalUrl)
    //    para enviar al usuario a la pagina de aprobacion de PayPal.
